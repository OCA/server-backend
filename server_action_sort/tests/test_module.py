...
class TestModule(TransactionCase):
    ...
    def setUp(self):
        ...
        self.action_server = self.env.ref(
            "server_action_sort.sort_action_server_lines")
        self.line_1 = self.env.ref(
            "server_action_sort.sort_action_server_lines_line_1")
        self.line_2 = self.env.ref(
            "server_action_sort.sort_action_server_lines_line_2")
    ...
    def test_action_result(self):
        ...
        self.action_server.with_context(
            ...
            active_ids=[self.action_server.id]).run()
